<?php
class AnotesModel extends Query
{
    private $titulo, $descripcion, $id, $estado;
    ...
    {
        $sql = "SELECT * FROM anotes";
        $data = $this->selectAll($sql);
        return $data;
    }
    public function RegistrarAnotes(string $titulo, string $descripcion)
    {
        $this->titulo = $titulo;
        $this->descripcion = $descripcion;


        $sql = "INSERT INTO anotes(titulo,descripcion)VALUES(?,?)";///no funciona
        $datos = array($this->titulo, $this->descripcion);
