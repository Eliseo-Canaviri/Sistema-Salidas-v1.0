...
{
    private $gastos, $descripcion, $id,$id_usuario, $estado;
    ...
    public function getEgresos(int $id_usuario)
    {
        $sql = "SELECT * FROM egresos WHERE id_usuario=$id_usuario";
    ...
    {
        $sql = "SELECT SUM(gasto) AS suma_total FROM egresos;";
        $data = $this->selectAll($sql);
        return $data;
    }
    public function TotalIngresos()
    {
        $sql = "SELECT ingreso  FROM ingresos   ";
        $data = $this->selectAll($sql);
        return $data;
    }
    public function RegistrarEgresos(string $gastos, string $descripcion,int $id_usuario)
    {
        $this->gastos = $gastos;
        ...
        $sql = "INSERT INTO egresos(gasto,descripcion,id_usuario)VALUES(?,?,?)";///no funciona
        $datos = array($this->gastos, $this->descripcion, $this->id_usuario);
